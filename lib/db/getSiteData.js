    ...
    allPages: [
      {
        ...
        pageCover: BLOG.HOME_BANNER_IMAGE || null,
...
export function getNavPages({ allPages }) {
  ...
  return allNavPages.map(item => ({
    id: item.id,
    title: item.title || '',
    pageCoverThumbnail: item.pageCoverThumbnail || item.pageCover || BLOG.HOME_BANNER_IMAGE || null,
    pageCover: item.pageCover || BLOG.HOME_BANNER_IMAGE || null,
