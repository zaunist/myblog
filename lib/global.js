...
export function GlobalContextProvider(props) {
  ...
  // 使用传入的路由加载状态，确保与_app.js中的加载状态保持一致
  const [onLoading, setOnLoading] = useState(loadingRouteChange || false) // 抓取文章数据
  
  // 当loadingRouteChange变化时更新onLoading
  useEffect(() => {
    setOnLoading(loadingRouteChange || false)
  }, [loadingRouteChange])
